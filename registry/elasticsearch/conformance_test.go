...
// (oauthPassThru, apiKeyAuth, sigV4Auth, tlsAuth, tlsAuthWithCACert,
// tlsSkipVerify, serverName, timeout, keepCookies, index, interval, timeField,
// maxConcurrentShardRequests, timeInterval, includeFrozen, defaultQueryMode,
// logMessageField, logLevelField, dataLinks) are the jsonData shape; its
// non-jsonData fields (URL, BasicAuth, BasicAuthUser, WithCredentials,
// Database, DecryptedSecureJSONData) are tagged json:"-" and are skipped by
