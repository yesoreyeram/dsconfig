...
// truth for the Zipkin datasource configuration.
//
//go:embed dsconfig.json
var configSchemaJSON []byte

// ConfigSchema parses, resolves, and returns the declarative dsconfig schema
// (single source of truth) for the Zipkin datasource.
func ConfigSchema() (*dsconfig.Schema, error) {
	return dsconfig.ParseAndResolveSchemaJSON(configSchemaJSON)
}

// NewSchema returns the full k8s-style SDK plugin schema for the Zipkin
...
// SettingsExamples returns k8s-style example configurations for the Zipkin
// datasource, covering the default configuration and each authentication
// method / TLS variant / Zipkin-specific feature the config editor supports.
