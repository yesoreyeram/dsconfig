...
// keepCookies, oauthPassThru, tracesToLogsV2, tracesToLogs, tracesToMetrics,
// nodeGraph, spanBar) are the jsonData shape; its non-jsonData fields (URL,
// BasicAuth, BasicAuthUser, WithCredentials, DecryptedSecureJSONData) are
// tagged json:"-" and are skipped by the conformance walker.
