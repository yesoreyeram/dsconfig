...
// (githubPlan, githubUrl, selectedAuthType, appId, installationId,
// cachingEnabled) are the jsonData shape; its non-jsonData fields
// (AppIdInt64, InstallationIdInt64, Secrets) are tagged json:"-" and are
