...
// (tlsAuth, tlsAuthWithCACert, tlsSkipVerify, serverName, timeout, keepCookies,
// oauthPassThru, manageAlerts, allowAsRecordingRulesTarget, timeInterval,
// queryTimeout, defaultEditor, disableMetricsLookup, prometheusType,
// prometheusVersion, cacheLevel, incrementalQuerying, incrementalQueryOverlapWindow,
// disableRecordingRules, customQueryParameters, httpMethod, seriesLimit,
// seriesEndpoint, exemplarTraceIdDestinations,
// maxSamplesProcessedWarningThreshold, maxSamplesProcessedErrorThreshold) are
// the jsonData shape; its non-jsonData fields (URL, BasicAuth, BasicAuthUser,
// WithCredentials, DecryptedSecureJSONData) are tagged json:"-" and are skipped
