...
// (apiType, environmentId, domain, tlsSkipVerify, tlsAuthWithCACert,
// httpClientTimeout) are the jsonData shape; its DecryptedSecureJSONData field
// is tagged json:"-" and is skipped by the conformance walker.
