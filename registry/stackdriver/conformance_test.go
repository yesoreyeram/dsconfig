...
// wifServiceAccountEmail, oauthPassThru, universeDomain, gceDefaultProject) are
// the jsonData shape; the DecryptedSecureJSONData field is tagged json:"-" and
// is skipped by the conformance walker.
