...
// (storage, queryParams, tlsAuth, tlsAuthWithCACert, tlsSkipVerify,
// serverName, timeout, keepCookies, oauthPassThru) are the jsonData shape;
// its non-jsonData fields (URL, BasicAuth, BasicAuthUser, WithCredentials,
