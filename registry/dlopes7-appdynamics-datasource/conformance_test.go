...
// (tlsSkipVerify, clientName, clientDomain, analyticsURL, globalAccountName)
// are the jsonData shape; its non-jsonData fields (MetricsURL, ClientSecret,
// BasicAuthUsername, BasicAuthPassword, AnalyticsAPIKey,
