...
//
// The Config struct is the settings model: its json-tagged fields (connection,
// authType, kerberosUser, keyTabFilePath, globalCcacheFilePath, ccacheLookupFile,
// serverName, tlsAuth, tlsAuthWithCACert, tlsSkipVerify, responseRowsLimit,
// validate, user, skipTLSValidation, credentials) are the jsonData shape; its
// non-jsonData fields (BasicAuthEnabled, BasicAuthUser, DecryptedSecureJSONData)
// are tagged json:"-" and are skipped by the conformance walker.
