...
// (account, username, region, role, authType, warehouse, database, schema,
// defaultQuery, defaultVariableQuery, defaultInterpolation, timeInterval,
// loginTimeout, requestTimeout, settings, oauthPassThru, rowLimit) are the
// jsonData shape; DecryptedSecureJSONData is tagged json:"-" and is skipped by
