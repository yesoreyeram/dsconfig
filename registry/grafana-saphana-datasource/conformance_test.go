...
// (server, instance, databaseName, username, defaultSchema, timeout, port,
// tlsDisabled, tlsSkipVerify, tlsAuth, tlsAuthWithCACert) are the jsonData shape;
// its non-jsonData field (DecryptedSecureJSONData) is tagged json:"-" and is
