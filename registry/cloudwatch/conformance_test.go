...
// (authType, profile, assumeRoleArn, externalId, proxyType, proxyUrl,
// proxyUsername, endpoint, defaultRegion, customMetricsNamespaces,
// logsTimeout, logGroups, defaultLogGroups, tracingDatasourceUid) are the
