...
// .gen.json artifacts.
//
// Neither Hello service requires authentication, so there is no secureJsonData.
// The shared schema.RunPluginTests requires at least one secure key (and its
