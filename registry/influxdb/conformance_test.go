...
// keepCookies, oauthPassThru, dbName, version, httpMode, timeInterval,
// showTagTime, defaultBucket, organization, maxSeries, insecureGrpc,
// product, pdcInjected) are the jsonData shape; its non-jsonData fields
// (URL, BasicAuth, BasicAuthUser, User, Database, WithCredentials,
