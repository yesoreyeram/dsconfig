...
// (customHealthCheckEnabled, customHealthCheck, tlsAuth, tlsAuthWithCACert,
// tlsSkipVerify, serverName, oauthPassThru) are the jsonData shape; its
// non-jsonData fields (URL, BasicAuth, BasicAuthUser, WithCredentials,
// DecryptedSecureJSONData) are tagged json:"-" and are skipped by the
// conformance walker. The nested customHealthCheck.* leaves are declared
// as `section` fields in dsconfig.json and matched against
// CustomHealthCheckConfig's json tags by the section-aware struct walk.
