...
// (authKind, uri, grpcEndpoint, authEndpoint, user, secure) are the jsonData
// shape; its non-jsonData field (DecryptedSecureJSONData) is tagged json:"-"
// and is skipped by the conformance walker.
