...
// workspaceId, assumeRoleArnWriter) are the jsonData shape; its
// non-jsonData fields (DecryptedSecureJSONData) are tagged json:"-" and
// are skipped by the conformance walker.
