...
// (authenticationType, defaultProject, clientEmail, tokenUri, privateKeyPath,
// usingImpersonation, serviceAccountToImpersonate, workloadIdentityPoolProvider,
// wifServiceAccountEmail, oauthPassThru, processingLocation, serviceEndpoint,
// MaxBytesBilled, flatRateProject, queryPriority) are the jsonData shape; the
// DecryptedSecureJSONData field is tagged json:"-" and is skipped by the
// conformance walker.
