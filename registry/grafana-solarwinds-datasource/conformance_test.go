...
// .gen.json artifacts; without the flag it runs the full guard-rail suite. The
// secure keys (solarwinds.password and the solarwinds.tls.* certificates/key) are
// compared against the schema's secureJsonData fields.
