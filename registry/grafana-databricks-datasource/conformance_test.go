...
// (host, httpPath, authType, clientId, tenantId, azureCloud, azureCredentials,
// oauthPassThru, retries, pause, timeout, rows, retryTimeout, debug,
// enableUnitySupport, defaultQueryFormat, cloudFetch) are the jsonData shape;
// its DecryptedSecureJSONData field is tagged json:"-" and is skipped by the
// conformance walker.
