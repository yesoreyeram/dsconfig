...
// (oauthPassThru, sigV4Auth, tlsAuth, tlsAuthWithCACert, tlsSkipVerify,
// serverName, timeout, keepCookies, database, interval, timeField, serverless,
// flavor, version, versionLabel, maxConcurrentShardRequests, timeInterval,
// pplEnabled, logMessageField, logLevelField, dataLinks) are the jsonData
// shape; its non-jsonData fields (URL, BasicAuth, BasicAuthUser, User,
