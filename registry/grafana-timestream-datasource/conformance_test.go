...
// defaultDatabase, defaultTable, defaultMeasure) are the jsonData shape;
// its non-jsonData fields (Database — the legacy root-level profile fallback
// — and DecryptedSecureJSONData) are tagged `json:"-"` and are skipped by
