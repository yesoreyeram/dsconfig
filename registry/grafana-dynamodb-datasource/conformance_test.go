...
// fields (authType, profile, endpoint, defaultRegion, isV2, timeout,
// retries, pause, region, accessId) are the jsonData shape; its
// non-jsonData fields (DecryptedSecureJSONData) are tagged json:"-"
// and are skipped by the conformance walker.
