...
// (authType, profile, assumeRoleArn, externalId, endpoint, defaultRegion,
// useServerless, useManagedSecret, clusterIdentifier, workgroupName,
// managedSecret (nested arn+name), dbUser, database, withEvent) are the
// jsonData shape; its non-jsonData fields (DecryptedSecureJSONData) are
