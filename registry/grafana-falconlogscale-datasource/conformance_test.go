...
// (baseUrl, authenticateWithToken, oauthPassThru, oauth2, oauth2ClientId, mode,
// defaultRepository, dataLinks, incrementalQuerying,
// incrementalQueryOverlapWindow, keepCookies, timeout) are the jsonData shape;
// its non-jsonData fields (URL, BasicAuth, BasicAuthUser,
