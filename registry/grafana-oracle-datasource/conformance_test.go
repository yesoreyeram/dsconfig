...
// (timezone_name, use_dst, database, user, useTNSNamesBasedConnection,
// tnsNamesEntry, useKerberosAuthentication, connectionPoolSize, dataProxyTimeout,
// prefetchRowsCount, rowLimit) are the jsonData shape; its non-jsonData fields
// (URL, DecryptedSecureJSONData) are tagged json:"-" and are skipped by the
// conformance walker.
