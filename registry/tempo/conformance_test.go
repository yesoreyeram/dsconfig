...
// (tlsAuth, tlsAuthWithCACert, tlsSkipVerify, serverName, timeout,
// keepCookies, oauthPassThru, streamingEnabled, tracesToLogsV2, tracesToLogs,
// tracesToMetrics, tracesToProfiles, serviceMap, nodeGraph, spanBar, search,
// traceQuery, timeRangeForTags, tagLimit) are the jsonData shape; its
