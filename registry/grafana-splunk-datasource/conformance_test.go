...
//
// The Config struct itself is the settings model: its json-tagged fields are the
// jsonData shape; its root fields (URL, BasicAuthUser) and DecryptedSecureJSONData
