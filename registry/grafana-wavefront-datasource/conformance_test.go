...
//
// The Config struct itself is the settings model: its json-tagged fields (url,
// requestTimeout) are the jsonData shape; its non-jsonData field
// (DecryptedSecureJSONData) is tagged json:"-" and is skipped by the
// conformance walker.
