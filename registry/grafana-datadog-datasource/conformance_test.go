...
// (pluginMode, url, logApiRateLimits, rateLimitEnabled, rateLimitMetrics,
// disableDataLinks, size) are the jsonData shape; its non-jsonData fields
// (BasicAuthEnabled, BasicAuthUser, DecryptedSecureJSONData) are tagged
// json:"-" and are skipped by the conformance walker.
